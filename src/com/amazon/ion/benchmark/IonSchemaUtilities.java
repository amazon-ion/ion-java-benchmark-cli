...
public class IonSchemaUtilities {
     ...
     */
    // TODO: Support processing <TYPE_REFERENCE> :: = <TYPE_ALIAS> | <IMPORT_TYPE>
    public static ReparsedType parseTypeReference(IonValue field) {
        ...
        return new ReparsedType(typeDefinition);
    }
}
